...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        main.personList.add(new Person(1,"Bob", "Manager", "Soldier Korzuna home 1", new String[]{"+79218811688"}));
        main.personList.add(new Person(2,"Oleg", "Gamer", "Home", new String[]{"+79288836688", "+79221855677"}));

        while (loop) // Запускаем бесконечный цикл работы программы
        {
            main.personList.sort(new PersonSort());
            ...
            {
                System.out.println(main.personList.get(i).getId() + "\t" + main.personList.get(i).getName() + "\t" + main.personList.get(i).getPost() +
                        "\t" + main.personList.get(i).getAddress() + "\t" + main.personList.get(i).getPhoneNumbers()[0]);
            }
